...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, PopupMenu.OnMenuItemClickListener, RVAdapter.Delegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RVAdapter(results,this.getApplicationContext(),this);
        ...
        observer = foodFound -> {
            ...
            for (int i = 0; i < results.size(); i++) {
                MarkerOptions markerOptions = new MarkerOptions()
                        ...
                        .position(new LatLng(results.get(i).getGeometry().getLocation().getLat(),
        ...
        menu = new PopupMenu(this,menuChooser);
        menuInflater = this.getMenuInflater();
        menuInflater.inflate(R.menu.search_types_menu,menu.getMenu());
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                for(int i = 0; i<results.size(); i++){
                    if(results.get(i).getName().equals(marker.getTitle())){
